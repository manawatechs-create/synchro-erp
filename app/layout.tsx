...
export const metadata: Metadata = {
  ...
  keywords: ['ERP agricole', 'gestion coopérative', 'coopérative agricole', 'Synchro ERP', 'Manawa Techs', 'PWA agricole', 'digitalisation agricole', 'Burkina Faso'],
  manifest: '/manifest.json',
  appleWebApp: { capable: true, statusBarStyle: 'default', title: 'Synchro ERP' },
  openGraph: { title: 'Synchro ERP - Solution de Gestion pour Coopératives Agricoles', description: 'Plateforme SaaS complète pour digitaliser votre coopérative agricole.', type: 'website', locale: 'fr_FR' },
}
